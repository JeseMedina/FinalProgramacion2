 ...
 * @author Jesé
 */
public class EgresosForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form EgresosForm
     */
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fecha Incio", "Fecha Final", "Egresos"
            }
        ) {
    ...
    void listar() {
        List<Egresos> lista = edao.Listar();
    ...
    void listarFecha(String in, String fi) {
        List<Egresos> lista = edao.listarFecha(in, fi);
        modelo = (DefaultTableModel) tabla.getModel();
        Object[] ob = new Object[3];
        for (int i = 0; i < lista.size(); i++) {
